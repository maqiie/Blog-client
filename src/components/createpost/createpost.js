...
const CreatePost = ({ currentUser }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://blog-api0.onrender.com/categories")
      .then((response) => {
    ...
    if (currentUser) {
      ...
      axios
        .get(`https://blog-api0.onrender.com/users/${userId}/posts`, {
          headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://blog-api0.onrender.com/posts",
        formData,
        { headers }
      );
  ...
  const handleDeletePost = (userId, postId) => {
    ...
    axios
      .delete(`https://blog-api0.onrender.com/users/${userId}/posts/${postId}`)
      .then((response) => {
        // Handle success
